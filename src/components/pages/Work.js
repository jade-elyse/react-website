...
export default function Work() {
  return (
    ...
    <div class="Title">
        ...
        <div aria-hidden class="Title__filled">Work</div>
    </div>
    </div>
    </div>
    <div className="text-box">
      <h1>New Talent Apprentice</h1>
      {/* <p>Currently I am a New Talent Apprentice at BBC Scotland working as a Software Engineer in the homepage team. Prior to working at the BBC, I was a Customer Service Assistant at Glasgow Science Centre that done both the roles of a Science Communicator and Front of House.</p>   */}
