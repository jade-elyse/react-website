...
export default function University() {
  return (
    ...
    <div class="Title">
        ...
        <div aria-hidden class="Title__filled">University</div>
    </div>
    </div>
    </div>
    <div className="text-box">
      <h1>Software Engineer Graduate Apprentice</h1>
      {/* <p>Since November 2020, I have been studying at the University of Glasgow to eventually become a full-time programmer. I am doing this as part of the graduate apprenticeship scheme alongside the BBC. This will be the first year that BBC Scotland have ran the program :D</p>   */}
